...
class TouchButton
{
    public:
        ...
        TouchButton(uint8_t pin, uint32_t dbTime=25, uint8_t puEnable=true, uint8_t invert=true)
...
class ToggleButton : public TouchButton
{
    public:
        ...
        ToggleButton(uint8_t pin, bool initialState=false, uint32_t dbTime=25, uint8_t puEnable=true, uint8_t invert=true)
            : TouchButton(pin, dbTime, puEnable, invert), m_toggleState(initialState) {}
